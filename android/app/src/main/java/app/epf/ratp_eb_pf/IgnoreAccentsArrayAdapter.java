        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            if (prefix == null || prefix.length() == 0) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (valueText.startsWith(prefixString) || valueTextNoPalatals.startsWith(prefixStringNoPalatals) || valueText.contains(prefixString)) {
                        newValues.add(value);
                    } else {
                        ...
                        if (valueText.startsWith(prefixes[0]) || (loc = valueText.indexOf(' ' + prefixes[0])) > -1 || valueText.contains(prefixString))
